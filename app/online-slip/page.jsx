...
<div className='mt-10'>
  ...
  <form class="flex flex-row gap-4 items-center">
    ...
    <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 w-64">
    ...
    <input type="number" placeholder="Roll Number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3 w-64" />
  </form>
