...
function Navbar() {
  // States to control dropdown and mobile menu
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" className="flex items-center flex-col space-x-3 rtl:space-x-reverse">
          <img
            src="https://bisempk.edu.pk/img/bise_logo.png"
            className="h-20"
            alt="BISE Logo"
          />
